...
$nomeDestinatario = 'Site Castro Lima - Quero Comprar um Lote';
...
$assunto = "Desejo Comprar em " . $_POST['loteamento'];
...
echo "<meta HTTP-EQUIV='Refresh' CONTENT='0;URL=../php/querocomprar.php'>";
